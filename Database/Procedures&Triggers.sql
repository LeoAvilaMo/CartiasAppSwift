...
USE icaritasborregos;
GO CREATE PROCEDURE GetRetoStats @ID_USUARIO NUMERIC(18, 0) AS BEGIN -- Count total number of RETOS
...
END;
GO CREATE PROCEDURE GetRecentDatosFisicosByUsuario @ID_USUARIO NUMERIC(18, 0) AS BEGIN
SELECT TOP 5 *
FROM DATOS_FISICOS
WHERE ID_USUARIO = @ID_USUARIO
