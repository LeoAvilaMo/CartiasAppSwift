...
GO -- Utilizar la base de datos iborreguitos
...
GO
ALTER TABLE [HISTORICO]
ADD FOREIGN KEY ([ID_TIPO]) REFERENCES [BENEFICIOS] ([ID_BENEFICIO]);
GO
ALTER TABLE [USUARIOS]
ADD FOREIGN KEY ([ID_TIPO_USUARIO]) REFERENCES [TIPO_USUARIO] ([ID_TIPO_USUARIO]);
GO
ALTER TABLE [USUARIOS_BENEFICIOS]
ADD FOREIGN KEY ([USUARIO]) REFERENCES [USUARIOS] ([ID_USUARIO]);
GO
ALTER TABLE [USUARIOS_BENEFICIOS]
ADD FOREIGN KEY ([BENEFICIO]) REFERENCES [BENEFICIOS] ([ID_BENEFICIO]);
GO
ALTER TABLE [USUARIOS_EVENTOS]
ADD FOREIGN KEY ([USUARIO]) REFERENCES [USUARIOS] ([ID_USUARIO]);
GO
ALTER TABLE [USUARIOS_EVENTOS]
ADD FOREIGN KEY ([EVENTO]) REFERENCES [EVENTOS] ([ID_EVENTO]);
GO
ALTER TABLE [USUARIOS_RETOS]
ADD FOREIGN KEY ([ID_USUARIO]) REFERENCES [USUARIOS] ([ID_USUARIO]);
GO
ALTER TABLE [USUARIOS_RETOS]
ADD FOREIGN KEY ([ID_RETO]) REFERENCES [RETOS] ([ID_RETO]);
GO